  ...
  try {
    ...
    await db.runTransaction(async function (tx) {
      ...
      var base = {
        ...
        upline: String(uData.upline || uplineId),
        uplineUid: String(uData.uplineUid || uplineId),
        sponsorUid: String(uData.sponsorUid || uplineId),
        sponsorId: String(uData.sponsorId || uplineId),
        parentUid: String(uData.parentUid || uplineId),
        referrerUid: String(uData.referrerUid || uplineId),
        referrerId: String(uData.referrerId || uplineId),
        invitedByUid: String(uData.invitedByUid || uplineId),
        usedReferralCode: String(uData.usedReferralCode || referralCode),
        referralCodeUsed: String(uData.referralCodeUsed || referralCode),
        refCodeUsed: String(uData.refCodeUsed || referralCode),
        sponsorCode: String(uData.sponsorCode || referralCode),
        uplineCode: String(uData.uplineCode || referralCode),
        uplineReferralCode: String(uData.uplineReferralCode || referralCode),
        referrerCode: String(uData.referrerCode || referralCode),
        invitedByCode: String(uData.invitedByCode || referralCode),
